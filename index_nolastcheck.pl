...
#            $subnetnumdis = $subnetnum . ".0";
        ...
        #print $counter;
        $out .=
"<tr bgcolor=grey><td colspan=7><font size=+1><font color=linen><b>$subnetdesc</b> ($subnetnumdis.0/24)</font></td></tr>";
        $out .=
...
<td><b>Schemas</b></td>
<td><b>SN Desc</b></td><td><b><a title='Click to sort' href=index.pl?$snparams&o=m>Modified</a></b></td></tr>\n";
        ...
        $query2 =
"SELECT i.id,i.ipaddr, i.hostname, i.portnum, i.modified, s.subnet, s.description, v.val AS mysql_version,v2.val as srhostname, v3.val as verscom,i.notes,i.all_schemas
        ...
        $out .=
"<tr bgcolor=white><td colspan=7>$divider Total hosts known: $hcounter</td></tr>";
...
$whereclause="  
 ...
 ";
    ...
    $query =
"SELECT s.id,s.subnet, s.description,i.id,i.ipaddr,i.hostname,i.portnum,v.val as mysqlversion,v2.val as srhostname,v3.val as verscom,i.modified,i.notes,i.all_schemas FROM sc_subnet s left join sc_instance i on i.subnetint=s.subnetint 
...
<td><b>Schemas</b></td>
<td><b>SN Desc</b></td><td><b><a title='Click to sort' href=index.pl?str=$string&o=m>Modified</a></b></td></tr>\n";

    
    $sth2 = $dbh->prepare($query);
    $sth2->execute() or die($DBI::errstr);
    $sth2->bind_columns( undef, \$subnetid, \$subnetnum, \$subnetdesc,\$id,\$ipaddr, \$hostname,    \$portnum,\$mysqlversion,
               \$srhostname, \$verscom ,\$modified,\$notes,\$allschemas);
    ...
    $counter = 0;
        ...
        if (length($allschemas) >= 25) {
          $allschemas.="...";
            ...
            $out .= "<tr bgcolor=$bgcolor><td><a class=srv href=serverdetails.pl?s=$id title='Click for server details'>$ipaddr:$portnum</a></td><td><a class=srv href=serverdetails.pl?s=$id title='Click for server details'>$displayhostname</a></td></td><td>$mysqlversion $verscom</td><td>$subnetnum</td><td>$allschemas</td><td>$subnetdesc</td><td>$modified</td></tr>\n";
