...
"<tr><td bgcolor=$bgcolor>$keyname1</td><td bgcolor=$bgcolor class=var>$val1</td><td bgcolor=$bgcolor class=var>$val2</td></tr>\n";
    ...
    $diffout =
"<table class=var-table align=center><tr bgcolor=silver><td><b>Variable</b></td><td><b>$hostname:$portnum<br>($srhostname/$ipaddr)<br>RUNNING CONFIGURATION</b></td><td><b>$hostname:$portnum<br>($srhostname/$ipaddr)<br>my.cnf settings</b></td></tr>\n"
      . $diffout
      . "</table>";
